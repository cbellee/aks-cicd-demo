...
resource hub_peering_to_spoke 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2022-07-01' = [for i in range(0, (length(vNets) - 1)): {
...
resource spoke_peering_to_hub 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2022-07-01' = [for i in range(0, (length(vNets) - 1)): {
